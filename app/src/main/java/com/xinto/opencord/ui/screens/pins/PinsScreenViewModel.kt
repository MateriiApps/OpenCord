...
class PinsScreenViewModel(
    private val data: PinsScreenData,
    messageStore: MessageStore,
    channelStore: ChannelStore,
) : ViewModel() {

    var state by mutableStateOf<PinsScreenState>(PinsScreenState.Loading)
